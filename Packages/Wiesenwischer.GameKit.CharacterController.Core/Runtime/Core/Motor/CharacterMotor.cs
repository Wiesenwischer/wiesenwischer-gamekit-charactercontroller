...
#pragma warning restore 0649
        ...
        /// <summary>
        /// Convenience property: Returns true if currently stable on ground
        /// </summary>
        public bool IsStableOnGround => GroundingStatus.IsStableOnGround;

        /// <summary>
        /// Convenience property: Returns true if character just landed this frame
        /// </summary>
        public bool JustLanded => GroundingStatus.IsStableOnGround && !LastGroundingStatus.IsStableOnGround;

        /// <summary>
        /// Convenience property: Returns true if character just left ground this frame
        /// </summary>
        public bool JustLeftGround => !GroundingStatus.IsStableOnGround && LastGroundingStatus.IsStableOnGround;
        ...
        public bool LastMovementIterationFoundAnyGround;
        /// <summary>
        /// Index of this motor in CharacterMotorSystem arrays
        /// </summary>
        [NonSerialized]
...
#pragma warning restore 0414
        ...
        {
            CharacterMotorSystem.EnsureCreation();
            CharacterMotorSystem.RegisterCharacterMotor(this);
        }

        private void OnDisable()
        {
            CharacterMotorSystem.UnregisterCharacterMotor(this);
        }
        ...
        /// </summary>
        public float Radius => CapsuleRadius;

        /// <summary>
        /// Returns the capsule height
        /// </summary>
        public float Height => CapsuleHeight;
    }
}
